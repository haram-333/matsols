                ...
                <div className="container services-hero__content">
                    <div className="anim-hidden anim-up">
                        ...
                        <div className="services-hero__cta">
                            <Link to="/what-we-offer" className="btn btn-primary btn-orange">Explore Services</Link>
                    ...
                    <div className="offerings-grid">
                        ...
                        <div className="offering-card anim-hidden anim-left">
                            ...
                            <div className="offering-content">
                                ...
                                <Link to="/register" className="offering-btn btn-orange">Start Application</Link>
                            </div>
                        </div>
                        ...
                        <div className="offering-card anim-hidden anim-right">
                            ...
                            <div className="offering-content">
                                ...
                                <Link to="/what-we-offer/visa-support" className="offering-btn btn-dark">Get Visa Advice</Link>
                            </div>
                        </div>
                        ...
                        <div className="offering-card anim-hidden anim-left">
                            ...
                            <div className="offering-content">
                                ...
                                <Link to="/degrees" className="btn btn-primary btn-orange" style={{ width: '100%' }}>Find Scholarships</Link>
                            </div>
                        </div>
                        ...
                        <div className="offering-card anim-hidden anim-right">
                            ...
                            <div className="offering-content">
                                ...
                                <Link to="/free-consultation" className="btn btn-dark" style={{ width: '100%' }}>View Housing</Link>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="services-final-cta">
                <div className="container anim-hidden anim-zoom">
                    ...
                    <div style={{ display: 'flex', gap: '20px', justifyContent: 'center' }}>
                        <Link to="/free-consultation" className="btn" style={{ background: 'white', color: 'var(--primary-orange)' }}>Book Free Consultation</Link>
                        <Link to="/free-consultation" className="btn btn-outline" style={{ borderColor: 'white', color: 'white' }}>Contact Us</Link>
                    </div>
                </div>
            </section>
