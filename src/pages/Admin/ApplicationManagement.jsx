...
const ApplicationManagement = () => {
    ...
    if (loading) return <div className="loading">Loading Management Data...</div>;
    ...
    return (
        <div className="admin-content application-mgmt fade-in">
            ...
            <style>{`
                .management-tabs { display: flex; gap: 20px; margin-bottom: 30px; border-bottom: 1px solid #e2e8f0; }
                .tab-btn { padding: 12px 20px; background: none; border: none; font-weight: 600; color: #64748b; cursor: pointer; position: relative; }
                ...
                .status-select { padding: 4px 10px; font-size: 13px; height: auto; }
                ...
                .status-tag { padding: 2px 8px; borderRadius: 12px; fontSize: 11px; fontWeight: bold; text-transform: uppercase; }
